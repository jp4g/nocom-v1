...
def apy_to_rate_per_second(apy: int) -> int:
    """
    Convert APY to rate per second using simple linear approximation.
    
    Args:
        apy: Annual percentage yield in tenths of percent (e.g., 52 for 5.2%)
    
    Returns:
        Rate per second scaled by WAD
    """
    WAD = 10**18  # Standard 18 decimal precision
    SECONDS_PER_YEAR = 365 * 24 * 60 * 60  # 31,536,000
    
    numerator = apy * WAD
    denominator = 1000 * SECONDS_PER_YEAR  # 31,536,000,000
