...
/**
 * Aztec client for interacting with escrow and pool contracts
 * Supports both lending and stable pool/escrow types
 */
export class AztecClient {
   ...
   * Works for both lending and stable pools - they have the same API
   */
