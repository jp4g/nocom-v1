...
export default function StableRepayModal({
  ...
  const handleRepay = async () => {
    ...
    try {
      const amount = parseTokenAmount(inputValue);
      console.log('Repaying stable amount (burn):', amount.toString());

      // Use repayDebtByBurn for stable positions - burns zUSD instead of transferring
      ...
      toast.error('Failed to repay stable debt');
      onClose();
    } finally {
      setIsProcessing(false);
    }
        ...
        {isProcessing ? (
          <div className="p-6">
            ...
            <div className="flex flex-col items-center justify-center py-12">
              ...
              <p className="text-sm text-text-muted">Burning stablecoins to repay debt...</p>
            </div>
          </div>
        ) : (
          <>
