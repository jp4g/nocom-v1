      ...
      <div className="glass-panel rounded-xl overflow-hidden shadow-2xl">
        ...
        <div className="p-6">
          <div className="flex justify-between items-end mb-6">
            <h3 className="text-lg text-white font-medium">Nocom.Fi Markets</h3>
            <div className="flex gap-2">
              <span className="px-3 py-1 rounded-md bg-white/5 text-xs text-white border border-white/10">All</span>
              <span className="px-3 py-1 rounded-md text-xs text-neutral-500 hover:text-white transition-colors cursor-pointer">Isolated Debt</span>
          ...
          <div className="space-y-1 mt-2">
            ...
            <div className="grid grid-cols-4 md:grid-cols-5 gap-4 px-4 py-4 rounded-lg hover:bg-white/[0.02] transition-colors items-center group cursor-pointer">
              <div className="col-span-2 md:col-span-2 flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-xs text-neutral-500 font-mono">BTC</div>
                </div>
              </div>
            ...
            <div className="grid grid-cols-4 md:grid-cols-5 gap-4 px-4 py-4 rounded-lg hover:bg-white/[0.02] transition-colors items-center group cursor-pointer">
              <div className="col-span-2 md:col-span-2 flex items-center gap-3">
                <div className="w-8 h-8 rounded-full bg-purple-500/20 text-purple-300 flex items-center justify-center font-bold text-xs border border-purple-500/30">◎</div>
                <div>
                  <div className="text-white text-sm font-medium">Solana</div>
                  <div className="text-xs text-neutral-500 font-mono">SOL</div>
                </div>
              </div>
              <div className="text-right font-mono text-sm text-white">892.4K</div>
            ...
            <div className="grid grid-cols-4 md:grid-cols-5 gap-4 px-4 py-4 rounded-lg hover:bg-white/[0.02] transition-colors items-center group cursor-pointer">
              <div className="col-span-2 md:col-span-2 flex items-center gap-3">
                <div className="w-8 h-8 rounded-full bg-yellow-500/20 text-yellow-400 flex items-center justify-center font-bold text-xs border border-yellow-500/30">Z</div>
                <div>
                  <div className="text-white text-sm font-medium">Zcash</div>
                  <div className="text-xs text-neutral-500 font-mono">ZEC</div>
                </div>
              </div>
              <div className="text-right font-mono text-sm text-white">410.1K</div>
