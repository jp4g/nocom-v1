    ...
    <section className="max-w-7xl mx-auto px-6 py-24">
      <div className="grid md:grid-cols-3 gap-8">
        ...
        <div className="glass-panel p-8 rounded-xl group hover:border-indigo-500/30 transition-all duration-300">
          ...
          <h3 className="text-xl text-white font-medium mb-3">Isolated Markets</h3>
          <p className="text-sm text-neutral-400 leading-relaxed">
        ...
        <div className="glass-panel p-8 rounded-xl group hover:border-indigo-500/30 transition-all duration-300">
          ...
          <p className="text-sm text-neutral-400 leading-relaxed">
            Use assets like ZEC to privately collateralize the zUSD stablecoin. Leverage your shielded assets without leaking any public data.
          </p>
        </div>
      </div>
    </section>
